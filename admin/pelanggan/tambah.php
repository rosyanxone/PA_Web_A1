    ...
    if(isset($_POST['register'])) {
        ...
        if($password === $cPassword) {
            ...
            if(mysqli_fetch_assoc($hasil)) {
                ...
                $push_data = mysqli_query($conn, "INSERT INTO user (username, nama, telepon, alamat, level, password) VALUES ('$username', '$nama', '$telepon', '$alamat', '$level', '$password')");
...
<body>
    <div class="mainDaftar">
        ...
        <form class="formDaftar" method="POST">
            ...
            <p      class="loginDaftar" align="center"><a href="../pelanggan.php">Kembali</p>
        </form>
    </div>
</body>
</html>